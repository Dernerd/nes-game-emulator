 ...
 */
/*
Plugin Name: NES Game Emulator
Plugin URI: https://wordpress.org/plugins/retro-game-emulator/
Description: Führe einen NES-Emulator auf Deiner Wordpress-Seite aus.
Version: 1.3.2
Author: DerN3rd
...
$MyUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://n3rds.work//wp-update-server/?action=get_metadata&slug=nes-game-emulator', 
	__FILE__, 
	'nes-game-emulator' 
);
...
if (! function_exists('add_action')) {
	echo "Hallo! Ich bin nur ein Plugin, nicht viel kann ich tun, wenn ich direkt angerufen werde.";
	exit;
}
	...
	class RetroGameEmulator
	{
		...
		public function __construct()
		{
			...
			add_action('wp_enqueue_scripts', function () {
				...
				wp_enqueue_script('retro-game-emulator-app', plugins_url('lib/app.js', __FILE__), array('jsnes'), '1.3.2');
			});
			...
			*/
			...
			add_action('admin_menu', function () {
				add_options_page('NES Emulator', 'NES Emulator', 'administrator', 'retro-game-emulator', array($this, 'optionsPage'));
			});
